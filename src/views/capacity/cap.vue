            ...
            <el-row gutter="250">
              ...
              <el-col :span="10">
                <el-form-item label="对象类型">
                  <el-input  size="mini" placeholder="虚机资源池" disabled></el-input>
                </el-form-item>
              </el-col>

              <el-col :span="10">
                <el-form-item label="数据粒度">
                  <el-input size="mini" placeholder="1天" disabled></el-input>
                </el-form-item>
              </el-col>

              <el-col :span="10">
                <el-form-item label="指标名称">
                  <el-input size="mini" placeholder="虚机开通资源" disabled></el-input>
                </el-form-item>
              </el-col>
            ...
                        <el-row gutter="250">
                            <el-col :span="10">
                ...
                >
                                    
                  <div>
                                       <el-radio v-model="radio" disabled label="4"
                      >小时</el-radio
                    >
                                      <el-radio v-model="radio" disabled label="2"
                      >日</el-radio
                    >
                                      <el-radio v-model="radio" disabled label="3"
                      >周</el-radio
                    >
