                            ...
                            <el-row gutter="250">
                                <el-col :span="10">
                                    <el-form-item label="学件名称">
                                        <el-input
                                                style="{width: '50%';}" placeholder="存储资源优化" disabled
                                        ></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="10">
                                    <el-form-item label="对象类型">
                                        <el-input placeholder="HDFS" disabled></el-input>
                                    </el-form-item>
                                </el-col>

                                <el-col :span="10">
                                    <el-form-item label="数据粒度">
                                        <el-input placeholder="1分钟" disabled></el-input>
                                    </el-form-item>
                                </el-col>

                                <el-col :span="10">
                                    <el-form-item label="指标名称">
                                        <el-input placeholder="HDFS存储" disabled></el-input>
                                    </el-form-item>
                                </el-col>

                                <el-col :span="10">
                                    <el-form-item label="指标单位">
                                        <el-input style="{width: '30%';}" placeholder="GB" disabled>
                                        </el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
...
<!--                                        <el-form-item label="基线高限" label-width="75px">-->
                                            <el-input placeholder="40743562" disabled :style="{ width: '30%' }">
                                            </el-input>
<!--                                        </el-form-item>-->
