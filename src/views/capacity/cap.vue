                            ...
                            <el-row gutter="250">
                                <el-col :span="10">
                                    <el-form-item label="学件名称">
                                        <el-input
                                                style="{width: '50%';}" placeholder="资源池容量预测" disabled
                                        ></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="10">
                                    <el-form-item label="对象类型">
                                        <el-input placeholder="虚机资源池" disabled></el-input>
                                    </el-form-item>
                                </el-col>

                                <el-col :span="10">
                                    <el-form-item label="数据粒度">
                                        <el-input placeholder="1天" disabled></el-input>
                                    </el-form-item>
                                </el-col>

                                <el-col :span="10">
                                    <el-form-item label="指标名称">
                                        <el-input placeholder="虚机开通资源" disabled></el-input>
                                    </el-form-item>
                                </el-col>

                                <el-col :span="10">
                                    <el-form-item label="指标单位">
                                        <el-input style="{width: '30%';}" placeholder="C" disabled>
                                        </el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            ...
                            <el-row gutter="50">
                                ...
                                <el-col :span="10">
                                    <el-form-item label="容量基线" label-width="75px">
                                        <el-radio disabled v-model="radio" label="2">基线低线</el-radio>

<!--                                        <el-form-item label="基线低线" label-width="75px">-->
                                            <el-input :style="{ width: '30%' }" disabled>
                                            </el-input>

<!--                                        </el-form-item>-->
                                        <el-radio disabled v-model="radio" label="1">基线高限</el-radio>
<!--                                        <el-form-item label="基线高限" label-width="75px">-->
                                            <el-input placeholder="85000" disabled :style="{ width: '30%' }">
                                            </el-input>
<!--                                        </el-form-item>-->
            ...
                              <div>
                               <el-radio v-model="radio" label="4">小时</el-radio>
...
                      "
            ...
                              <el-col span="5">
                                <el-input suffix-icon="el-icon-date" placeholder="01:30" size="mini"
                                                                disabled
                                                                style="
                         {
                          width: '40%';
